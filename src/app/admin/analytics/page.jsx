...
import { Users, Activity, AlertTriangle, Server, TrendingUp, TrendingDown, Clock, Calendar } from 'lucide-react';
...
const CHART_DATA = {
  ...
  lobbies: [65, 72, 78, 85, 89],
  reports: [280, 265, 250, 240, 234]
};
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Pantau performa dan statistik platform</p>
      </div>
