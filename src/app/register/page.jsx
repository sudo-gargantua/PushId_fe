...
// import { useRouter } from 'next/navigation'; // Di-disable sementara untuk preview
import { Eye, EyeOff, CheckSquare, Square, Apple, Loader2 } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    // FIX: Menggunakan struktur Layout yang SAMA PERSIS dengan Login Page
    // Warna background disamakan ke #020617
    <div className="min-h-screen w-full flex bg-[#020617] text-white font-sans overflow-hidden">
      ...
      {/* --- BAGIAN KANAN (FORM) --- */}
      {/* Lebar 45% (Total 100% dengan kiri) */}
      <div className="w-full lg:w-[45%] flex flex-col justify-center items-center px-6 py-12 bg-[#020617] relative z-20 h-full overflow-y-auto">
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <div className="flex gap-8 mb-6 text-lg font-semibold pl-1">
            <a href="/login" className="text-slate-500 hover:text-slate-300 transition-colors cursor-pointer">
              Login
            </a>
